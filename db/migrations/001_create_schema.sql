...
DROP POLICY IF EXISTS transcripts_backend_only ON transcripts;
CREATE POLICY transcripts_backend_only ON transcripts FOR ALL TO anon, authenticated USING (false) WITH CHECK (false);
DROP POLICY IF EXISTS email_notifications_backend_only ON email_notifications;
...
DROP POLICY IF EXISTS notifications_backend_only ON notifications;
